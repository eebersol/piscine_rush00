...
<div class="form">
<form id="modif_pwd_form" class="std" method="post" action="form_admin_modif_user_2.php">
	<fieldset>
		<h3>Modifier mes Informations</h3>
		<div class="labele">
		<label for="oldmail">OldMail : </label><input id="oldmail" type="text" name="oldmail" /> <br>
		<label for="newmail">NewMail : </label><input id="newmail" type="text" name="newmail" /> <br>
		...
		<label for="adress">Adresse : </label><input id="adress" type="text" name ="adress" /> <br>
		<label for="city">Ville : </label><input id="city" type="text" name ="city" /> <br>
		<label for="phone">Telephone : </label><input id="telephone" type="telephone" name="phone"> <br>
